...
[![My Skills](https://skillicons.dev/icons?i=py,php,js,ts,dart,sklearn,tensorflow,react,django,laravel,flutter,postgres,mysql,git,github,githubactions,docker,kubernetes,aws,nginx,ubuntu,stripe)](https://skillicons.dev)
