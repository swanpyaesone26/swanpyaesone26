...
[![My Skills](https://skillicons.dev/icons?i=py,php,js,ts,dart,go,sklearn,tensorflow,react,django,laravel,flutter,postgres,mysql,git,github,githubactions,terraform,ansible,docker,kubernetes,aws,nginx,ubuntu,stripe)](https://skillicons.dev)
